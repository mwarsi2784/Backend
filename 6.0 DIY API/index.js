...
app.get("/random",(req,res)=>{
  ...
  res.send(JSON.stringify(jokes[i]));
});
...
app.get("/jokes/:id",(req,res)=>{
  ...
  console.log(Id);
  res.json(jokes.find( jokes => jokes.id == Id));
});
...
app.get("/filter",(req,res)=>{
  ...
  console.log(t);
  res.json(jokes.filter( jokes => jokes.jokeType == t));
});
...
app.put("/jokes/:id",(req,res)=>{
    const Id=req.params.id;
    const id = Id-1;
    jokes[id].jokeText=req.body.text;
    jokes[id].jokeType=req.body.type;
    res.sendStatus(200);
});
...
app.patch("/jokes/:id",(req,res)=>{
  ...
  console.log(id);
  // console.log(jokes[0].jokeText);
  // console.log(jokes[0].jokeType);
  if (req.body.type) {
    console.log(`Updating joke type to: ${req.body.type}`);
    jokes[id].jokeType = req.body.type;
  }
  if (req.body.text) {
    console.log(`Updating joke text to: ${req.body.text}`);
    jokes[id].jokeText = req.body.text;
  }
...
app.delete("/jokes/:id",(req,res)=>{
  const id=req.params.id;
  const ind=jokes.findIndex(jokes => jokes.id == id);
  jokes.splice(ind,1);
  res.sendStatus(200);
});
